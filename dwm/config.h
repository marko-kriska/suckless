...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:size=10:antialias=true:hinting=true";
...
static const char *mixer[]      = { "st", "--class", "pulsemixer,pulsemixer", "-e", "pulsemixer", NULL };
static const char *rss[]        = { "st", "--class", "newsboat,newsboat", "-e", "newsboat", NULL };
...
static const char *screen_1[]   = { "screen_1.sh", NULL };
static const char *screen_2[]   = { "screen_2.sh", NULL };
