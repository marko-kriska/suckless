...
static const char *fonts[]          = { "JetBrains Mono:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "JetBrains Mono:size=10:antialias=true:hinting=true";
