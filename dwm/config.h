...
static const char *fonts[]          = { "IntelOne Mono:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "IntelOne Mono:size=10:antialias=true:hinting=true";
