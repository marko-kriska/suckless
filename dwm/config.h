...
static const char *fonts[]          = { "Intel One Mono:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Intel One Mono:size=10:antialias=true:hinting=true";
...
static const char *mixer[]      = { "kitty", "--class", "pulsemixer,pulsemixer", "-e", "pulsemixer", NULL };
static const char *rss[]        = { "kitty", "--class", "newsboat,newsboat", "-e", "newsboat", NULL };
