...
static const char *fonts[]          = { "IBM Plex Mono:weight=Text:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "IBM Plex Mono:weight=Text:size=10:antialias=true:hinting=true";
