...
static const char *fonts[]          = { "Cascadia Code:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Cascadia Code:size=10:antialias=true:hinting=true";
